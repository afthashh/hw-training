...
class OLXScraper:
    ...
    def parse_property(self, selector, absolute_url, property_id):
        ...
        price_currency = '₹'
        data = {
            "property_name": selector.xpath('//h1[@data-aut-id="itemTitle"]/text()').get(),
            "property_id": property_id,  # Use the extracted property_id
            "breadcrumbs": selector.xpath('//div[@data-aut-id="breadcrumb"]//ol//li/a/text()').getall(),
            "price": {
                "amount": price_amount,
            ...
            "property_type": selector.xpath('//span[@data-aut-id="key_type"]/following-sibling::span[@data-aut-id="value_type"]/text()').get(),
